...
const ToolsRT = (() => {
  ...
  window.calcGap = function() {
    ...
    const html = `<div class="result-panel" id="gap-result">
  ...
  window.calcHypo = function() {
    ...
    const html = `<div class="result-panel" id="hyp-result">
  ...
  window.calcElectron = function() {
    ...
    const html = `<div class="result-panel" id="el-result">
  ...
  window.calcMU = function() {
    ...
    const html = `<div class="result-panel" id="mu-result">
  ...
  window.calcSSD = function() {
    ...
    const html = `<div class="result-panel" id="ssd-result">
  ...
  window.calcISL = function() {
    ...
    const i2 = i1 * (d1/d2)**2;
    const html = `<div class="result-panel" id="isl-result">
  ...
  window.calcHVL = function() {
    ...
    const html = `<div class="result-panel" id="hvl-result">
