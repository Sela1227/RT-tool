      ...
      <div class=" rounded-xl  mb-2 px-4 py-3 flex items-start justify-between gap-2">
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 mb-0.5 flex-wrap">
            ...
            <span class="text-xs px-2 py-0.5 rounded-full ${catColors[d.cat]||' text-gray-600'}">${d.cat}</span>
          </div>
        ...
        <button onclick="ICDCopy('${d.code}')" id="copy-${d.code.replace(/\./g,'')}"
          class="flex-shrink-0 text-xs text-gray-400 transition-colors p-1 rounded-lg hover:">
