...
const UIConstraints = (() => {
  ...
  function getStarred()   { return lsGet('rttool_starred_constraints', []); }
  function getOverrides() { return lsGet('rttool_override_constraints', {}); }
  function getCustom()    { return lsGet('rttool_custom_constraints', []); }
  ...
  window.ConToggleStar = function(id) {
    ...
    lsSet('rttool_starred_constraints', starred);
    refreshResults();
  };
  ...
  window.ConSaveOverride = function(id) {
    ...
    lsSet('rttool_override_constraints', ov); ConCloseModal(); refreshResults();
  };
  ...
  window.ConSaveCustomEdit = function(id) {
    ...
    lsSet('rttool_custom_constraints', custom); ConCloseModal(); refreshResults();
  };
  ...
  window.ConDelete = function(id) {
    ...
    lsSet('rttool_custom_constraints', custom); refreshResults();
  };
