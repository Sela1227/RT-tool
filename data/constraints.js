const CONSTRAINTS_DATA = [
  ...
  // ── NCCN SBRT — Lung SABR (NCCN NSCLC 2024) ──────────
  {id:90, organ:"Spinal Cord",param:"Dmax",limit:18,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:"NSCLC SABR 3fx"},
  {id:91, organ:"Spinal Cord",param:"Dmax",limit:25,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:"NSCLC SABR 5fx"},
  {id:92, organ:"Lung",param:"V20",limit:10,unit:"%",tech:"SBRT_3fx",source:"NCCN",notes:"Total lung - GTV; NSCLC SABR"},
  {id:93, organ:"Lung",param:"V20",limit:15,unit:"%",tech:"SBRT_5fx",source:"NCCN",notes:"Total lung - GTV"},
  {id:94, organ:"Lung",param:"MLD",limit:4,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:"Mean lung dose"},
  {id:95, organ:"Lung",param:"MLD",limit:7,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:"Mean lung dose"},
  {id:96, organ:"Esophagus",param:"Dmax",limit:27,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:"NSCLC SABR 3fx"},
  {id:97, organ:"Esophagus",param:"Dmax",limit:35,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:"NSCLC SABR 5fx"},
  {id:98, organ:"Heart",param:"Dmax",limit:30,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:""},
  {id:99, organ:"Heart",param:"Dmax",limit:38,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:100,organ:"Trachea/Bronchus",param:"Dmax",limit:30,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:"Proximal bronchial tree"},
  {id:101,organ:"Trachea/Bronchus",param:"Dmax",limit:40,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:102,organ:"Chest Wall",param:"Dmax",limit:30,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:"Superficial 3fx"},
  {id:103,organ:"Chest Wall",param:"Dmax",limit:40,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:104,organ:"Brachial Plexus",param:"Dmax",limit:24,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:""},
  {id:105,organ:"Brachial Plexus",param:"Dmax",limit:30.5,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:106,organ:"Skin",param:"Dmax",limit:24,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:""},
  {id:107,organ:"Skin",param:"Dmax",limit:32,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},

  // ── NCCN SBRT — Liver SBRT (NCCN HCC 2024) ───────────
  {id:108,organ:"Liver (normal)",param:"Volume",limit:700,unit:"cc",tech:"SBRT_3fx",source:"NCCN",notes:"Normal liver ≥700cc; Child-Pugh A"},
  {id:109,organ:"Liver (normal)",param:"Volume",limit:700,unit:"cc",tech:"SBRT_5fx",source:"NCCN",notes:"Child-Pugh A"},
  {id:110,organ:"Liver",param:"Dmean",limit:13,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:"Total liver mean dose"},
  {id:111,organ:"Liver",param:"Dmean",limit:18,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:112,organ:"Kidney (bilateral)",param:"Dmean",limit:10,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:"Liver SBRT context"},
  {id:113,organ:"Duodenum",param:"Dmax",limit:24,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:"Liver/pancreas SBRT"},
  {id:114,organ:"Stomach",param:"Dmax",limit:22,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:""},
  {id:115,organ:"Stomach",param:"Dmax",limit:32,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},

  // ── NCCN SBRT — Spine SBRT (NCCN CNS 2024) ───────────
  {id:116,organ:"Spinal Cord",param:"Dmax",limit:14,unit:"Gy",tech:"SBRT_1fx",source:"NCCN",notes:"Spine SBRT; 0.35cc"},
  {id:117,organ:"Cauda Equina",param:"Dmax",limit:16,unit:"Gy",tech:"SBRT_1fx",source:"NCCN",notes:""},
  {id:118,organ:"Cauda Equina",param:"Dmax",limit:22,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:""},
  {id:119,organ:"Cauda Equina",param:"Dmax",limit:30,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:120,organ:"Nerve Root",param:"Dmax",limit:16,unit:"Gy",tech:"SBRT_1fx",source:"NCCN",notes:""},
  {id:121,organ:"Nerve Root",param:"Dmax",limit:22,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:""},
  {id:122,organ:"Nerve Root",param:"Dmax",limit:30,unit:"Gy",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:123,organ:"Esophagus",param:"Dmax",limit:14.5,unit:"Gy",tech:"SBRT_1fx",source:"NCCN",notes:"Spine SBRT"},
  {id:124,organ:"Esophagus",param:"Dmax",limit:17.7,unit:"Gy",tech:"SBRT_3fx",source:"NCCN",notes:""},

  // ── NCCN SBRT — Prostate SBRT (NCCN Prostate 2024) ───
  {id:125,organ:"Rectum",param:"V36",limit:1,unit:"cc",tech:"SBRT_5fx",source:"NCCN",notes:"Prostate SBRT 36.25 Gy/5fx"},
  {id:126,organ:"Rectum",param:"V29",limit:20,unit:"%",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:127,organ:"Rectum",param:"V18",limit:50,unit:"%",tech:"SBRT_5fx",source:"NCCN",notes:""},
  {id:128,organ:"Bladder",param:"V37",limit:10,unit:"%",tech:"SBRT_5fx",source:"NCCN",notes:"Prostate SBRT"},
  {id:129,organ:"Bladder",param:"V18",limit:40,unit:"%",tech:"SBRT_5fx",source:"NCCN",notes:""},
